  ...
  <body>
    ...
    <div class="container">
      <div class="hero-unit">
        ...
        <!-- j_spring_security_logout is a special url that spring security has. It is called to logout. 
         Spring security will go through and call session.invalidate - eliminating the cookies we have -  do anything we have like that inside of our
          application. It will go through and and handle that for us.  -->
