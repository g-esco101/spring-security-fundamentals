...
public class FitnessPermissionEvaluator implements PermissionEvaluator {
    ...
    // In production, I would tell you to set up a second level cache, or just a meme cache (something to that extent), 
    // so we're not querying the database for every method that we want to run inside of our application. 
